                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="flex gap-4 text-sm text-muted-foreground">
                    {performer.avg_batting != null && (
                      <span>
                        Avg: <span className="font-medium text-foreground">{Number(performer.avg_batting).toFixed(1)}</span>
                      </span>
                    )}
                    {performer.avg_strike_rate != null && (
                      <span>
                        SR: <span className="font-medium text-foreground">{Number(performer.avg_strike_rate).toFixed(1)}</span>
                      </span>
                    )}
                    {performer.total_wickets != null && (
                      <span>
                        Wkts: <span className="font-medium text-foreground">{performer.total_wickets}</span>
                      </span>
                    )}
                  </div>
                </div>
